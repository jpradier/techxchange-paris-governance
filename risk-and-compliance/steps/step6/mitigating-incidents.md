...
In this lab, we will focus on a Model metric performance deviation issue.
The metric will be the **Answer Relevance** Metric.
...
This should create an issue automatically assigned to the Use Case Owner.
If not, create the issue manually.
